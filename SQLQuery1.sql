...
group by w.CustomerCode,w.OrderDate
		
select SUM(o.OrderAmount) as OrderAmount,SUM(o.AdvanceAmount) AdvanceAmount,o.CustomerCode,c.FirstName+' '+c.LastName as FullName,ci.CityName as City,ag.AgentName
from Orders o 
